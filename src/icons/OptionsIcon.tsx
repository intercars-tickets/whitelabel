...
export function OptionsIcon({iconSize = ICON_SIZE_DEFAULT}: ISvgIcon) {
    return (<>


        <svg width={iconSize} height={iconSize} viewBox="0 0 32 32" enableBackground="new 0 0 32 32" id="Stock_cut"
             version="1.1">
            ...
            <g>
                ...
                <path
                    ...
                    fill="none" stroke="#000000" strokeLinejoin="round" strokeMiterlimit="10" strokeWidth="2"/>

                <circle cx="16" cy="16" fill="none" r="5" stroke="#000000" strokeLinejoin="round" strokeMiterlimit="10"
                        strokeWidth="2"/>
