...
export function DirectionsIcon({iconSize = ICON_SIZE_DEFAULT, svgStyle = {}}: ISvgIcon) {
    return <svg version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 32 32" height={iconSize} width={iconSize} fill="currentColor">
